 ...
 */
final class Version20230630164344 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE video (id INT NOT NULL, name VARCHAR(255) NOT NULL, description TEXT NOT NULL, thumbnail VARCHAR(255) DEFAULT NULL, video VARCHAR(255) NOT NULL, base_position VARCHAR(255) NOT NULL, ending_position VARCHAR(255) NOT NULL, date DATE NOT NULL, PRIMARY KEY(id))');
